...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/corerpc03x

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/corerpc03x: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/corerpc03x ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/src/common/buffer/byte_buffer.o: src/common/buffer/byte_buffer.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/buffer/byte_buffer.o src/common/buffer/byte_buffer.cpp

${OBJECTDIR}/src/common/buffer/shared_buffer.o: src/common/buffer/shared_buffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/buffer
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/buffer/shared_buffer.o src/common/buffer/shared_buffer.cpp

${OBJECTDIR}/src/common/buffer/shared_buffer_list.o: src/common/buffer/shared_buffer_list.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/buffer
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/buffer/shared_buffer_list.o src/common/buffer/shared_buffer_list.cpp

${OBJECTDIR}/src/common/net/io_service_pool.o: src/common/net/io_service_pool.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/net
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/net/io_service_pool.o src/common/net/io_service_pool.cpp

${OBJECTDIR}/src/common/net/message_dispatcher.o: src/common/net/message_dispatcher.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/net
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/net/message_dispatcher.o src/common/net/message_dispatcher.cpp

${OBJECTDIR}/src/common/net/service_skeleton.o: src/common/net/service_skeleton.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/net
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/net/service_skeleton.o src/common/net/service_skeleton.cpp

${OBJECTDIR}/src/common/net/tcp_client.o: src/common/net/tcp_client.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/net
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/net/tcp_client.o src/common/net/tcp_client.cpp

${OBJECTDIR}/src/common/net/tcp_connection.o: src/common/net/tcp_connection.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/net
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/net/tcp_connection.o src/common/net/tcp_connection.cpp

${OBJECTDIR}/src/common/net/tcp_server.o: src/common/net/tcp_server.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/net
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/net/tcp_server.o src/common/net/tcp_server.cpp

${OBJECTDIR}/src/common/rpc/protobuf_decoder.o: src/common/rpc/protobuf_decoder.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/rpc
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/rpc/protobuf_decoder.o src/common/rpc/protobuf_decoder.cpp

${OBJECTDIR}/src/common/rpc/rpc.pb.o: src/common/rpc/rpc.pb.cc 
	${MKDIR} -p ${OBJECTDIR}/src/common/rpc
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/rpc/rpc.pb.o src/common/rpc/rpc.pb.cc

${OBJECTDIR}/src/common/rpc/rpc_channel.o: src/common/rpc/rpc_channel.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/rpc
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/rpc/rpc_channel.o src/common/rpc/rpc_channel.cpp

${OBJECTDIR}/src/common/rpc/rpc_factory.o: src/common/rpc/rpc_factory.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/rpc
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/rpc/rpc_factory.o src/common/rpc/rpc_factory.cpp

${OBJECTDIR}/src/common/rpc/rpc_service_skeleton.o: src/common/rpc/rpc_service_skeleton.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/rpc
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/rpc/rpc_service_skeleton.o src/common/rpc/rpc_service_skeleton.cpp

${OBJECTDIR}/src/common/startup/XnuxDaemon.o: src/common/startup/XnuxDaemon.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/startup
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/startup/XnuxDaemon.o src/common/startup/XnuxDaemon.cpp

${OBJECTDIR}/src/common/startup/commander.o: src/common/startup/commander.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/startup
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/startup/commander.o src/common/startup/commander.cpp

${OBJECTDIR}/src/common/startup/main.o: src/common/startup/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/startup
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/startup/main.o src/common/startup/main.cpp

${OBJECTDIR}/src/common/startup/net_service.o: src/common/startup/net_service.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/startup
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/startup/net_service.o src/common/startup/net_service.cpp

${OBJECTDIR}/src/common/startup/service.o: src/common/startup/service.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/startup
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/startup/service.o src/common/startup/service.cpp

${OBJECTDIR}/src/common/startup/stdafx.o: src/common/startup/stdafx.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/startup
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/startup/stdafx.o src/common/startup/stdafx.cpp

${OBJECTDIR}/src/common/util/file_system.o: src/common/util/file_system.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/common/util
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/common/util/file_system.o src/common/util/file_system.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/corerpc03x
